        ...
        <div className="grid lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <form className="space-y-12 relative z-10">
                ...
                <div className="flex flex-col gap-6 pt-6">
                  <button type="submit" className="btn-gold w-full py-6 text-xl shadow-2xl shadow-brand-gold/30 cursor-pointer">
                    إرسال طلب الحجز الملكي
                    <Send size={24} />
                  </button>
                  <button type="button" className="w-full py-6 bg-emerald-500 text-white rounded-2xl font-bold text-xl shadow-xl shadow-emerald-500/20 hover:bg-emerald-600 transition-all flex items-center justify-center gap-4 cursor-pointer" onClick={() => window.open('https://wa.me/966553590935', '_blank')}>
          ...
          <div className="space-y-10">
            ...
            <div className="bg-white p-10 rounded-[2rem] border border-brand-gold/10 text-right shadow-xl">
              ...
              <a href="tel:+966553590935" className="flex items-center justify-center gap-3 py-4 border-2 border-brand-gold text-brand-gold rounded-xl font-bold hover:bg-brand-gold hover:text-white transition-all cursor-pointer">
                <Phone size={20} />
                تحدث مع خبير الآن
              </a>
            </div>
