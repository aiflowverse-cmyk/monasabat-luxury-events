          ...
          <div className="space-y-8 order-2 lg:order-1">
            <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl border border-brand-gold/5 text-right relative overflow-hidden">
              ...
              <div className="space-y-10 relative z-10">
                {[
                  ...
                  { label: 'رقم الجوال', value: '0553590935', icon: Phone, dir: 'ltr' },
            ...
            <div className="bg-brand-dark text-white p-10 rounded-[2.5rem] shadow-2xl border border-brand-gold/20 text-right flex flex-col items-center relative overflow-hidden group">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full py-4 bg-brand-gold text-white rounded-2xl font-bold text-center hover:bg-white hover:text-brand-gold transition-all shadow-xl shadow-brand-gold/20 cursor-pointer"
              >
                ابدأ المحادثة الآن
              </a>
            </div>
              ...
              <div className="relative z-10">
                ...
                <form className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="md:col-span-2 pt-4">
                    <button type="submit" className="w-full py-5 bg-brand-dark text-white rounded-2xl font-bold text-xl hover:bg-brand-gold transition-all shadow-2xl flex items-center justify-center gap-3 group cursor-pointer">
