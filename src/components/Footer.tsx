  ...
  return (
    <footer className="bg-brand-dark text-gray-400 pt-20 pb-10">
      ...
      <a
        ...
        className="fixed bottom-8 left-8 w-16 h-16 bg-emerald-500 text-white rounded-full flex items-center justify-center shadow-2xl shadow-emerald-500/40 hover:scale-110 transition-transform z-40 cursor-pointer"
      >
