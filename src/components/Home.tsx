    ...
    <div className="overflow-hidden bg-brand-beige">
            ...
            {featuredProducts.map((product, i) => (
              ...
              >
                ...
                <div className="p-8 text-right">
                  ...
                  <Link to="/booking" className="w-full py-3 rounded-xl border border-brand-gold text-brand-gold font-bold text-sm hover:bg-brand-gold hover:text-white transition-all block text-center cursor-pointer">
                    أضف للطلب
                  </Link>
                </div>
              </motion.div>
      ...
      <section className="py-32 bg-brand-dark text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <img src="https://hafalh.kaeef.com/storage/app/uploads/public/671/fb3/81a/671fb381aa48a329491916.jpg" alt="خلفية تجهيزات فاخرة" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              ...
              <a href="tel:+966553590935" className="px-16 py-6 rounded-2xl border-2 border-white/20 text-white font-bold text-2xl hover:bg-white/10 transition-all w-full sm:w-auto flex items-center justify-center gap-3 cursor-pointer">
                تحدث مع خبير
                <Phone size={28} />
              </a>
            </div>
