      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a 
              href="tel:+966553590935" 
              className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-brand-gold/20 text-brand-dark hover:bg-brand-gold hover:text-white transition-all text-sm font-bold cursor-pointer"
            >
              <Phone size={16} />
              <span>اتصل بنا</span>
            </a>
            <a 
              href="https://wa.me/966553590935" 
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-emerald-500 text-white hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/20 text-sm font-bold cursor-pointer"
            >
          ...
          <>
            ...
            >
              <div className="flex items-center justify-between mb-12">
                <button 
                  onClick={() => setIsOpen(false)}
                  className="p-2 text-gray-400 hover:text-brand-dark transition-colors cursor-pointer"
              ...
              <div className="mt-auto pt-8 border-t border-gray-100">
                <div className="flex flex-col gap-4">
                  <a href="tel:+966553590935" className="btn-outline-gold w-full text-center cursor-pointer">اتصل بنا</a>
                  <a href="https://wa.me/966553590935" className="btn-gold w-full bg-emerald-500 border-emerald-500 text-center cursor-pointer">واتساب</a>
                </div>
              </div>
            </motion.div>
          </>
